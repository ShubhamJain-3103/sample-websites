...
if ( ! class_exists( 'digital_agency_lite_Content_Creation' ) ) :

	/**
	 * digital_agency_lite_Content_Creation class.
	 */
	class digital_agency_lite_Content_Creation extends WP_Customize_Control {
		...
		/**
		 * digital_agency_lite_Content_Creation constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'digital_agency_lite_Content_Creation' );
