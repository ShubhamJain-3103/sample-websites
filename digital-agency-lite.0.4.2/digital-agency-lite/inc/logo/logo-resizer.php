...
function digital_agency_lite_customize_controls_js() {
	wp_enqueue_script( 'digital-agency-lite-customizer-controls', get_template_directory_uri() . 'inc/logo/js/customize-controls.js', array( 'jquery', 'customize-preview' ), '201709071000', true );
}
